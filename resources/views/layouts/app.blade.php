                ...
                <div class="content">
                    <nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand-lg navbar-top-combo" data-move-target="#navbarVerticalNav">
                        ...
                        <ul class="navbar-nav navbar-nav-icons ml-auto flex-row align-items-center">
                            <li class="nav-item">
                                <a class="nav-link px-0" target="_blank" href="{{URL::to('/')}}/login_to_messenger/{{ \Auth::user()->id }}">
                                    <span class="fab fa-facebook-messenger fs-4" data-fa-transform="shrink-7"></span>
                                </a>
                            </li>
                            <li class="nav-item">
